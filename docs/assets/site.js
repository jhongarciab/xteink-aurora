(() => {
  ...
  const messages = {
    en: {
      ...
      homeTitle: "xAurora Tools",
      homeSubtitle: "Small browser tools for xAurora. Everything runs locally in your browser.",
      latestFirmware: "Latest firmware: 1.3.0.35-cpr-vcodex",
      homeFlash: "Auto Flash",
      homeStats: "Reading Stats Editor",
      homeTools: "Tools",
      homeGithub: "GitHub",
      toolsTitle: "Tools",
      toolsSubtitle: "Useful browser tools for xAurora plus external utilities that fit the Xteink workflow.",
      toolsStatsTitle: "xAurora Reading Stats Editor",
      ...
      flashTitle: "Flash xAurora",
      flashSubtitle: "Install the latest xAurora firmware on your Xteink X3 or X4 from Chrome or Edge using Web Serial. It writes the inactive app partition and then switches boot to it.",
      ...
      flashButton: "Flash xAurora Firmware",
      flashButtonForDevice: "Flash xAurora Firmware for {device}",
      flashing: "Flashing...",
      ...
      flashComplete: "Flash complete. The device should reboot into xAurora.",
    ...
    es: {
      ...
      homeTitle: "Herramientas xAurora",
      homeSubtitle: "Pequeñas herramientas de navegador para xAurora. Todo se ejecuta localmente en tu navegador.",
      latestFirmware: "Último firmware: 1.3.0.35-cpr-vcodex",
      homeFlash: "Auto Flash",
      homeStats: "Editor de estadísticas",
      homeTools: "Herramientas",
      homeGithub: "GitHub",
      toolsTitle: "Herramientas",
      toolsSubtitle: "Herramientas de navegador para xAurora y utilidades externas útiles para el flujo de trabajo Xteink.",
      toolsStatsTitle: "Editor de estadísticas de lectura xAurora",
      ...
      flashTitle: "Flashear xAurora",
      flashSubtitle: "Instala el último firmware xAurora en tu Xteink X3 o X4 desde Chrome o Edge usando Web Serial. Escribe la partición de app inactiva y luego arranca desde ella.",
      ...
      flashButton: "Flashear firmware xAurora",
      flashButtonForDevice: "Flashear firmware xAurora para {device}",
      flashing: "Flasheando...",
      ...
      flashComplete: "Flasheo completado. El dispositivo debería reiniciar en xAurora.",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a xAurora. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.3.0.35-cpr-vcodex", homeStats: "Editor d'estadístiques",
      flashEyebrow: "Instal·lador des del navegador", flashTitle: "Flasheja xAurora", flashSubtitle: "Instal·la l'últim firmware xAurora al teu Xteink X3/X4 des de Chrome o Edge amb Web Serial. Escriu la partició d'app inactiva i després hi canvia l'arrencada.",
      ...
      flashButton: "Flasheja el firmware xAurora", flashing: "Flashejant...", readyStatus: "A punt. En prémer Flash s'obrirà el selector de port sèrie del navegador.", choosePort: "Tria el port sèrie ESP32-C3 a l'avís del navegador.",
      ...
      flashComplete: "Flasheig completat. El dispositiu hauria de reiniciar amb xAurora.", flashStopped: "Flasheig aturat. Revisa el missatge anterior abans de tornar-ho a intentar.", downloadBin: "Descarrega .bin", communityFlasher: "Flasher comunitari",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour xAurora. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.3.0.35-cpr-vcodex", homeStats: "Éditeur de statistiques",
      flashEyebrow: "Installateur dans le navigateur", flashTitle: "Flasher xAurora", flashSubtitle: "Installez le dernier firmware xAurora sur votre Xteink X3/X4 depuis Chrome ou Edge avec Web Serial. Il écrit la partition d'application inactive puis bascule le démarrage dessus.",
      ...
      flashButton: "Flasher le firmware xAurora", flashing: "Flash en cours...", readyStatus: "Prêt. Cliquer sur Flash ouvrira le sélecteur de port série du navigateur.", choosePort: "Choisissez le port série ESP32-C3 dans la fenêtre du navigateur.",
      ...
      flashComplete: "Flash terminé. L'appareil devrait redémarrer sur xAurora.", flashStopped: "Flash arrêté. Vérifiez le message ci-dessus avant de réessayer.", downloadBin: "Télécharger .bin", communityFlasher: "Flasher communautaire",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für xAurora. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.3.0.35-cpr-vcodex", homeStats: "Statistik-Editor",
      flashEyebrow: "Browserbasierter Installer", flashTitle: "xAurora flashen", flashSubtitle: "Installieren Sie die neueste xAurora-Firmware auf Ihrem Xteink X3/X4 mit Chrome oder Edge und Web Serial. Die inaktive App-Partition wird beschrieben und anschließend als Bootziel gesetzt.",
      ...
      flashButton: "xAurora-Firmware flashen", flashing: "Flashe...", readyStatus: "Bereit. Ein Klick auf Flash öffnet die serielle Geräteauswahl des Browsers.", choosePort: "Wählen Sie im Browserdialog den ESP32-C3-Seriellport.",
      ...
      flashComplete: "Flash abgeschlossen. Das Gerät sollte in xAurora neu starten.", flashStopped: "Flash gestoppt. Prüfen Sie die Meldung oben, bevor Sie es erneut versuchen.", downloadBin: ".bin herunterladen", communityFlasher: "Community-Flasher",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per xAurora. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.3.0.35-cpr-vcodex", homeStats: "Editor statistiche",
      flashEyebrow: "Installer nel browser", flashTitle: "Flash xAurora", flashSubtitle: "Installa l'ultimo firmware xAurora sul tuo Xteink X3/X4 da Chrome o Edge usando Web Serial. Scrive la partizione app inattiva e poi avvia da quella.",
      ...
      flashButton: "Flash firmware xAurora", flashing: "Flash in corso...", readyStatus: "Pronto. Premendo Flash si aprirà il selettore della porta seriale del browser.", choosePort: "Scegli la porta seriale ESP32-C3 nel prompt del browser.",
      ...
      flashComplete: "Flash completato. Il dispositivo dovrebbe riavviarsi in xAurora.", flashStopped: "Flash interrotto. Controlla il messaggio sopra prima di riprovare.", downloadBin: "Scarica .bin", communityFlasher: "Flasher community",
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para xAurora. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.3.0.35-cpr-vcodex", homeStats: "Editor de estatísticas",
      flashEyebrow: "Instalador no navegador", flashTitle: "Gravar xAurora", flashSubtitle: "Instale o firmware xAurora mais recente no seu Xteink X3/X4 pelo Chrome ou Edge usando Web Serial. Ele grava a partição de app inativa e depois muda o boot para ela.",
      ...
      flashButton: "Gravar firmware xAurora", flashing: "Gravando...", readyStatus: "Pronto. Clicar em Flash abrirá o seletor de dispositivo serial do navegador.", choosePort: "Escolha a porta serial ESP32-C3 no prompt do navegador.",
      ...
      flashComplete: "Flash concluído. O dispositivo deve reiniciar no xAurora.", flashStopped: "Flash interrompido. Verifique a mensagem acima antes de tentar de novo.", downloadBin: "Baixar .bin", communityFlasher: "Flasher da comunidade",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor xAurora. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.3.0.35-cpr-vcodex", homeStats: "Statistiekeditor",
      flashEyebrow: "Browserinstallatie", flashTitle: "xAurora flashen", flashSubtitle: "Installeer de nieuwste xAurora-firmware op je Xteink X3/X4 vanuit Chrome of Edge met Web Serial. De inactieve app-partitie wordt geschreven en daarna als bootdoel ingesteld.",
      ...
      flashButton: "xAurora-firmware flashen", flashing: "Flashen...", readyStatus: "Klaar. Klik op Flash om de seriële apparaatkiezer van de browser te openen.", choosePort: "Kies de ESP32-C3 seriële poort in de browsermelding.",
      ...
      flashComplete: "Flash voltooid. Het apparaat zou in xAurora moeten herstarten.", flashStopped: "Flash gestopt. Controleer het bericht hierboven voordat je opnieuw probeert.", downloadBin: ".bin downloaden", communityFlasher: "Communityflasher",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для xAurora. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.3.0.35-cpr-vcodex", homeStats: "Рэдактар статыстыкі",
      flashEyebrow: "Усталёўшчык у браузеры", flashTitle: "Прашыць xAurora", flashSubtitle: "Усталюйце апошнюю прашыўку xAurora на Xteink X3/X4 з Chrome або Edge праз Web Serial. Яна запісвае неактыўны app-раздзел і пераключае загрузку на яго.",
      ...
      latestPackage: "Апошні пакет прашыўкі", flashWarning: "Выкарыстоўвайце на сваю рызыку. Прашыўка кастомнага firmware можа не атрымацца, калі кабель адключыцца або прылада страціць сілкаванне.", unsupported: "Web Serial недаступны ў гэтым браузеры. Выкарыстоўвайце Chrome або Edge на камп'ютары або спампуйце binary уручную.", flashButton: "Прашыць xAurora", flashing: "Прашыўка...", readyStatus: "Гатова. Націск Flash адкрые выбар серыйнай прылады ў браузеры.", choosePort: "Выберыце серыйны порт ESP32-C3 у акне браузера.", openingConnection: "Адкрыццё злучэння з bootloader...", partitionOk: "Знойдзена стандартная OTA табліца раздзелаў CrossPoint/Xteink.", fetchingFirmware: "Спампоўваецца пакет прашыўкі...",
      firmwareDownloadFailed: "Не ўдалося спампаваць прашыўку", firmwareTooLarge: "Прашыўка занадта вялікая для app-раздзела: {size}.", firmwareTooSmall: "Прашыўка выглядае занадта малой. Падазроны файл не будзе прашыты.", currentBootTarget: "Бягучая загрузка: {current}. Наступная мэта прашыўкі: {target}.", writingOffset: "Запіс у offset {offset}...", partitionUnexpected: "Нечаканая канфігурацыя раздзелаў. Гэты браузерны flasher падтрымлівае толькі стандартную OTA табліцу CrossPoint/Xteink.", unknownFlashError: "Невядомая памылка прашыўкі", flashComplete: "Прашыўка завершана. Прылада павінна запусціцца ў xAurora.", flashStopped: "Прашыўка спынена. Праверце паведамленне вышэй перад паўторнай спробай.", downloadBin: "Спампаваць .bin", communityFlasher: "Community flasher", flashNote: "Аўтаматычны flasher выкарыстоўвае копію прашыўкі, апублікаваную з гэтай старонкай. Кнопка спампоўкі выкарыстоўвае asset з GitHub release.", manualTitle: "Ручная прашыўка праз PlatformIO", manualText: "Для dev-зборак клануйце repo, задайце upload port і выкарыстоўвайце PlatformIO.", stepPending: "Чакае", stepRunning: "Выконваецца", stepDone: "Гатова", stepFailed: "Памылка", stepConnect: "Падключыць прыладу", stepPartition: "Праверыць табліцу раздзелаў", stepDownload: "Спампаваць прашыўку", stepReadOtadata: "Прачытаць otadata", stepFlashApp: "Прашыць app-раздзел", stepFlashOtadata: "Прашыць otadata", stepReset: "Перазапусціць прыладу"
    },
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "xAurora үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.3.0.35-cpr-vcodex", homeStats: "Статистика редакторы",
      flashEyebrow: "Браузердегі орнатқыш", flashTitle: "xAurora flash", flashSubtitle: "Соңғы xAurora firmware нұсқасын Xteink X3/X4 құрылғысына Chrome немесе Edge арқылы Web Serial көмегімен орнатыңыз. Ол белсенді емес app бөлімін жазады және boot-ты соған ауыстырады.",
  ...
  Object.assign(messages, {
    cs: {
      ...
      latestPackage: "Nejnovější balíček firmwaru", flashWarning: "Použití na vlastní riziko. Flash vlastního firmwaru může selhat, pokud se odpojí kabel nebo zařízení ztratí napájení.", unsupported: "Web Serial není v tomto prohlížeči dostupný. Použijte Chrome nebo Edge na desktopu, nebo stáhněte binárku ručně.", flashButton: "Flashovat firmware xAurora", flashing: "Flashování...", readyStatus: "Připraveno. Kliknutí na Flash otevře výběr sériového zařízení v prohlížeči.", choosePort: "Vyberte sériový port ESP32-C3 v dialogu prohlížeče.", openingConnection: "Otevírání spojení s bootloaderem...", partitionOk: "Nalezena výchozí OTA tabulka oddílů CrossPoint/Xteink.", fetchingFirmware: "Stahování balíčku firmwaru...",
      firmwareDownloadFailed: "Stažení firmwaru selhalo", firmwareTooLarge: "Firmware je pro app oddíl příliš velký: {size}.", firmwareTooSmall: "Firmware vypadá příliš malý. Podezřelý soubor nebude flashován.", currentBootTarget: "Aktuální boot: {current}. Další cíl flashování: {target}.", writingOffset: "Zápis na offset {offset}...", partitionUnexpected: "Neočekávaná konfigurace oddílů. Tento prohlížečový flasher podporuje jen zařízení s výchozí OTA tabulkou CrossPoint/Xteink.", unknownFlashError: "Neznámá chyba flashování", flashComplete: "Flash dokončen. Zařízení by mělo nabootovat do xAurora.", flashStopped: "Flash zastaven. Před dalším pokusem zkontrolujte zprávu výše.", downloadBin: "Stáhnout .bin", communityFlasher: "Komunitní flasher", flashNote: "Automatický flasher používá kopii firmwaru publikovanou s touto stránkou. Tlačítko stažení používá asset z GitHub release.", manualTitle: "Ruční flash přes PlatformIO", manualText: "Pro vývojové buildy naklonujte repo, nastavte upload port a použijte PlatformIO.", stepPending: "Čeká", stepRunning: "Běží", stepDone: "Hotovo", stepFailed: "Chyba", stepConnect: "Připojit zařízení", stepPartition: "Ověřit tabulku oddílů", stepDownload: "Stáhnout firmware", stepReadOtadata: "Číst oddíl otadata", stepFlashApp: "Flashovat app oddíl", stepFlashOtadata: "Flashovat oddíl otadata", stepReset: "Resetovat zařízení"
    },
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til xAurora. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.3.0.35-cpr-vcodex", homeStats: "Statistikeditor",
      flashEyebrow: "Browserbaseret installer", flashTitle: "Flash xAurora", flashSubtitle: "Installer den nyeste xAurora-firmware på din Xteink X3/X4 fra Chrome eller Edge med Web Serial. Den skriver den inaktive app-partition og skifter derefter boot til den.",
    ...
    pl: {
      ...
      latestPackage: "Najnowszy pakiet firmware", flashWarning: "Używasz na własne ryzyko. Flash niestandardowego firmware może się nie udać, jeśli kabel zostanie odłączony lub urządzenie straci zasilanie.", unsupported: "Web Serial nie jest dostępny w tej przeglądarce. Użyj Chrome lub Edge na komputerze desktopowym albo pobierz binarkę ręcznie.", flashButton: "Flashuj firmware xAurora", flashing: "Flashowanie...", readyStatus: "Gotowe. Kliknięcie Flash otworzy wybór urządzenia szeregowego w przeglądarce.", choosePort: "Wybierz port szeregowy ESP32-C3 w oknie przeglądarki.", openingConnection: "Otwieranie połączenia z bootloaderem...", partitionOk: "Znaleziono domyślną tablicę partycji OTA CrossPoint/Xteink.", fetchingFirmware: "Pobieranie pakietu firmware...",
      firmwareDownloadFailed: "Pobieranie firmware nie powiodło się", firmwareTooLarge: "Firmware jest za duży dla partycji app: {size}.", firmwareTooSmall: "Firmware wygląda na zbyt mały. Podejrzany plik nie zostanie flashowany.", currentBootTarget: "Aktualny boot: {current}. Następny cel flashowania: {target}.", writingOffset: "Zapis do offsetu {offset}...", partitionUnexpected: "Nieoczekiwana konfiguracja partycji. Ten flasher obsługuje tylko urządzenia z domyślną tabelą OTA CrossPoint/Xteink.", unknownFlashError: "Nieznany błąd flashowania", flashComplete: "Flash zakończony. Urządzenie powinno uruchomić xAurora.", flashStopped: "Flash zatrzymany. Sprawdź komunikat powyżej przed kolejną próbą.", downloadBin: "Pobierz .bin", communityFlasher: "Flasher społeczności", flashNote: "Automatyczny flasher używa kopii firmware opublikowanej z tą stroną. Przycisk pobierania używa assetu z release GitHub.", manualTitle: "Ręczny flash przez PlatformIO", manualText: "Dla buildów deweloperskich sklonuj repo, ustaw port uploadu i użyj PlatformIO.", stepPending: "Oczekuje", stepRunning: "W toku", stepDone: "Gotowe", stepFailed: "Błąd", stepConnect: "Połącz z urządzeniem", stepPartition: "Sprawdź tablicę partycji", stepDownload: "Pobierz firmware", stepReadOtadata: "Czytaj partycję otadata", stepFlashApp: "Flashuj partycję app", stepFlashOtadata: "Flashuj partycję otadata", stepReset: "Resetuj urządzenie"
    },
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для xAurora. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.3.0.35-cpr-vcodex", homeStats: "Редактор статистики",
      flashEyebrow: "Установщик в браузере", flashTitle: "Прошить xAurora", flashSubtitle: "Установите последнюю прошивку xAurora на Xteink X3/X4 из Chrome или Edge через Web Serial. Она записывает неактивный app-раздел и переключает загрузку на него.",
  ...
  const localizedTools = {
    be: {
      ...
      toolsSubtitle: "Браўзерныя інструменты для xAurora і карысныя знешнія сэрвісы для Xteink.",
      toolsStatsTitle: "Рэдактар статыстыкі чытання xAurora",
    ...
    ca: {
      navTools: "Eines",
      navSupport: "Suport",
      toolsSubtitle: "Eines de navegador per a xAurora i utilitats externes útils per al flux Xteink.",
      toolsStatsTitle: "Editor d'estadístiques de lectura xAurora",
    ...
    cs: {
      navTools: "Nástroje",
      navSupport: "Podpora",
      toolsSubtitle: "Nástroje v prohlížeči pro xAurora a užitečné externí služby pro Xteink.",
      toolsStatsTitle: "Editor statistik čtení xAurora",
    ...
    da: {
      navTools: "Værktøjer",
      navSupport: "Støtte",
      toolsSubtitle: "Browserværktøjer til xAurora og nyttige eksterne tjenester til Xteink.",
      toolsStatsTitle: "xAurora læsestatistik-editor",
    ...
    nl: {
      ...
      navSupport: "Steun",
      toolsSubtitle: "Browserhulpmiddelen voor xAurora en nuttige externe diensten voor Xteink.",
      toolsStatsTitle: "xAurora leesstatistieken-editor",
      ...
      navTools: "Työkalut",
      navSupport: "Tuki",
      toolsSubtitle: "Selaintyökaluja xAuroraille ja hyödyllisiä ulkoisia palveluja Xteinkille.",
      toolsStatsTitle: "xAurora-lukutilastojen editori",
    ...
    fr: {
      navTools: "Outils",
      navSupport: "Soutien",
      toolsSubtitle: "Outils de navigateur pour xAurora et services externes utiles pour Xteink.",
      toolsStatsTitle: "Éditeur de statistiques de lecture xAurora",
    ...
    de: {
      ...
      toolsSubtitle: "Browser-Werkzeuge für xAurora und nützliche externe Dienste für Xteink.",
      toolsStatsTitle: "xAurora Lesestatistik-Editor",
    ...
    hu: {
      ...
      toolsSubtitle: "Böngészős eszközök xAurorahez és hasznos külső szolgáltatások Xteinkhez.",
      toolsStatsTitle: "xAurora olvasási statisztika szerkesztő",
    ...
    it: {
      navTools: "Strumenti",
      navSupport: "Supporto",
      toolsSubtitle: "Strumenti browser per xAurora e servizi esterni utili per Xteink.",
      toolsStatsTitle: "Editor statistiche di lettura xAurora",
    ...
    kk: {
      navTools: "Құралдар",
      navSupport: "Қолдау",
      toolsSubtitle: "xAurora үшін браузер құралдары және Xteink үшін пайдалы сыртқы сервистер.",
      toolsStatsTitle: "xAurora оқу статистикасы редакторы",
    ...
    lt: {
      ...
      toolsSubtitle: "Naršyklės įrankiai xAurora ir naudingi išoriniai servisai Xteink.",
      toolsStatsTitle: "xAurora skaitymo statistikos redaktorius",
    ...
    pl: {
      navTools: "Narzędzia",
      navSupport: "Wesprzyj",
      toolsSubtitle: "Narzędzia przeglądarkowe dla xAurora i przydatne zewnętrzne usługi dla Xteink.",
      toolsStatsTitle: "Edytor statystyk czytania xAurora",
    ...
    pt: {
      ...
      navSupport: "Apoiar",
      toolsSubtitle: "Ferramentas de navegador para xAurora e serviços externos úteis para Xteink.",
      toolsStatsTitle: "Editor de estatísticas de leitura xAurora",
    ...
    ro: {
      navTools: "Unelte",
      navSupport: "Susține",
      toolsSubtitle: "Unelte în browser pentru xAurora și servicii externe utile pentru Xteink.",
      toolsStatsTitle: "Editor statistici de citire xAurora",
    ...
    ru: {
      ...
      toolsSubtitle: "Браузерные инструменты для xAurora и полезные внешние сервисы для Xteink.",
      toolsStatsTitle: "Редактор статистики чтения xAurora",
    ...
    si: {
      navTools: "Orodja",
      navSupport: "Podpora",
      toolsSubtitle: "Brskalniška orodja za xAurora in uporabne zunanje storitve za Xteink.",
      toolsStatsTitle: "Urejevalnik bralnih statistik xAurora",
    ...
    sv: {
      navTools: "Verktyg",
      navSupport: "Stöd",
      toolsSubtitle: "Webbläsarverktyg för xAurora och användbara externa tjänster för Xteink.",
      toolsStatsTitle: "xAurora lässtatistikredigerare",
    ...
    tr: {
      navTools: "Araçlar",
      navSupport: "Destek",
      toolsSubtitle: "xAurora için tarayıcı araçları ve Xteink için yararlı harici servisler.",
      toolsStatsTitle: "xAurora okuma istatistikleri düzenleyici",
    ...
    uk: {
      ...
      toolsSubtitle: "Браузерні інструменти для xAurora і корисні зовнішні сервіси для Xteink.",
      toolsStatsTitle: "Редактор статистики читання xAurora",
    ...
    vi: {
      navTools: "Công cụ",
      navSupport: "Ủng hộ",
      toolsSubtitle: "Công cụ trình duyệt cho xAurora và các dịch vụ ngoài hữu ích cho Xteink.",
      toolsStatsTitle: "Trình chỉnh sửa thống kê đọc xAurora",
  ...
  const localizedHomeCards = {
    en: {
      homeSubtitle: "Firmware, auto-flash and local browser tools for xAurora on Xteink X3/X4.",
      ...
      homeSupportBody: "Support xAurora development on Ko-fi."
    },
    es: {
      homeSubtitle: "Firmware, auto flash y herramientas locales de navegador para xAurora en Xteink X3/X4.",
      ...
      homeSupportBody: "Apoya el desarrollo de xAurora en Ko-fi."
    },
    ca: {
      homeSubtitle: "Firmware, flash automàtic i eines locals de navegador per a xAurora a Xteink X3/X4.",
      ...
      homeSupportBody: "Dona suport al desenvolupament de xAurora a Ko-fi."
    },
    fr: {
      homeSubtitle: "Firmware, flash automatique et outils locaux de navigateur pour xAurora sur Xteink X3/X4.",
      ...
      homeSupportBody: "Soutenez le développement de xAurora sur Ko-fi."
    },
    de: {
      homeSubtitle: "Firmware, Auto-Flash und lokale Browser-Werkzeuge für xAurora auf dem Xteink X3/X4.",
      ...
      homeSupportBody: "Unterstützen Sie die Entwicklung von xAurora auf Ko-fi."
    },
    it: {
      homeSubtitle: "Firmware, flash automatico e strumenti locali del browser per xAurora su Xteink X3/X4.",
      ...
      homeSupportBody: "Sostieni lo sviluppo di xAurora su Ko-fi."
    },
    pt: {
      homeSubtitle: "Firmware, flash automático e ferramentas locais de navegador para xAurora no Xteink X3/X4.",
      ...
      homeSupportBody: "Apoie o desenvolvimento do xAurora no Ko-fi."
    },
    nl: {
      homeSubtitle: "Firmware, auto-flash en lokale browserhulpmiddelen voor xAurora op Xteink X3/X4.",
      ...
      homeSupportBody: "Steun de ontwikkeling van xAurora op Ko-fi."
    },
    be: {
      homeSubtitle: "Прашыўка, аўта-flash і лакальныя браўзерныя інструменты для xAurora на Xteink X3/X4.",
      ...
      homeSupportBody: "Падтрымайце распрацоўку xAurora на Ko-fi."
    },
    cs: {
      homeSubtitle: "Firmware, automatický flash a lokální nástroje v prohlížeči pro xAurora na Xteink X3/X4.",
      ...
      homeSupportBody: "Podpořte vývoj xAurora na Ko-fi."
    },
    da: {
      homeSubtitle: "Firmware, auto-flash og lokale browserværktøjer til xAurora på Xteink X3/X4.",
      ...
      homeSupportBody: "Støt udviklingen af xAurora på Ko-fi."
    },
    fi: {
      homeSubtitle: "Firmware, automaattinen flash ja paikalliset selaintyökalut xAuroraille Xteink X3/X4:ssä.",
      ...
      homeSupportBody: "Tue xAurorain kehitystä Ko-fissa."
    },
    hu: {
      homeSubtitle: "Firmware, automatikus flash és helyi böngészős eszközök xAurorahez Xteink X3/X4-en.",
      ...
      homeSupportBody: "Támogasd a xAurora fejlesztését Ko-fin."
    },
    kk: {
      homeSubtitle: "Xteink X3/X4 үшін xAurora firmware, авто-flash және жергілікті браузер құралдары.",
      ...
      homeSupportBody: "xAurora әзірлеуін Ko-fi арқылы қолдаңыз."
    },
    lt: {
      homeSubtitle: "Programinė įranga, automatinis flash ir vietiniai naršyklės įrankiai xAurora Xteink X3/X4.",
      ...
      homeSupportBody: "Paremkite xAurora kūrimą Ko-fi."
    },
    pl: {
      homeSubtitle: "Firmware, auto flash i lokalne narzędzia przeglądarkowe dla xAurora na Xteink X3/X4.",
      ...
      homeSupportBody: "Wesprzyj rozwój xAurora na Ko-fi."
    },
    ro: {
      homeSubtitle: "Firmware, flash automat și unelte locale de browser pentru xAurora pe Xteink X3/X4.",
      ...
      homeSupportBody: "Susține dezvoltarea xAurora pe Ko-fi."
    },
    ru: {
      homeSubtitle: "Прошивка, авто-flash и локальные браузерные инструменты для xAurora на Xteink X3/X4.",
      ...
      homeSupportBody: "Поддержите разработку xAurora на Ko-fi."
    },
    si: {
      homeSubtitle: "Firmware, samodejni flash in lokalna brskalniška orodja za xAurora na Xteink X3/X4.",
      ...
      homeSupportBody: "Podprite razvoj xAurora na Ko-fi."
    },
    sv: {
      homeSubtitle: "Firmware, auto flash och lokala webbläsarverktyg för xAurora på Xteink X3/X4.",
      ...
      homeSupportBody: "Stöd utvecklingen av xAurora på Ko-fi."
    },
    tr: {
      homeSubtitle: "Xteink X3/X4 üzerinde xAurora için firmware, otomatik flash ve yerel tarayıcı araçları.",
      ...
      homeSupportBody: "xAurora geliştirmesini Ko-fi üzerinde destekleyin."
    },
    uk: {
      homeSubtitle: "Прошивка, авто-flash і локальні браузерні інструменти для xAurora на Xteink X3/X4.",
      ...
      homeSupportBody: "Підтримайте розробку xAurora на Ko-fi."
    },
    vi: {
      homeSubtitle: "Firmware, auto flash và công cụ trình duyệt cục bộ cho xAurora trên Xteink X3/X4.",
      ...
      homeSupportBody: "Ủng hộ phát triển xAurora trên Ko-fi."
    }
  };
  ...
  const localizedTitles = Object.fromEntries(languages.map(([language]) => [language, "xAurora"]));
