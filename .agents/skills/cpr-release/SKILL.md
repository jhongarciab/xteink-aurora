---
name: cpr-release
description: Use when preparing xAurora releases, version bumps, GitHub tags, firmware artifacts, release notes, CI checks, GitHub Pages, browser auto-flash, docs/firmware/manifest.json, or docs/flash.html.
---
...
```powershell
python -X utf8 scripts/sync_autoflash_firmware.py --repo jhongarciab/xteink-aurora
```
