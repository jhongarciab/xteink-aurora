#!/usr/bin/env python3
"""Inspect an EPUB for xAurora first-load risk factors.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inspect an EPUB for xAurora load/cache-build risk factors.")
