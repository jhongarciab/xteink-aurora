...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    default:
      LOG_DBG("UI", "Using Lyra xAurora theme");
...
int UITheme::getStatusBarHeight() {
  ...
  const bool showStatusBar = SETTINGS.statusBarChapterPageCount || SETTINGS.statusBarBookPageCount || SETTINGS.statusBarBookProgressPercentage ||
