...
- `xaurora`: this fork, focused on reading consistency and statistics.
...
- Prefer selective cherry-picks over blind large merges when upstream changed
  architecture near xAurora features.
- Keep xAurora-specific UX and stats behavior unless upstream fixes a real
