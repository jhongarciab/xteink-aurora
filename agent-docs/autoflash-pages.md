...
```bash
python scripts/sync_autoflash_firmware.py --repo jhongarciab/xteink-aurora
```
...
```bash
python scripts/pre_release_check.py --tag 1.2.0.39-xaurora --skip-build --allow-existing-tag
```
...
```text
https://jhongarciab.github.io/xteink-aurora/
```
